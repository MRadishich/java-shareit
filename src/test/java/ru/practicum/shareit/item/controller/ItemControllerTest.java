...
class ItemControllerTest {
    ...
    @Test
    @SneakyThrows
    public void createItem_whenItemNameIsNull_thenReturnBadRequest() {
        //given
        ...
        //then
        verify(itemService, never()).createItem(invalidItemDto, userId);
    }

    @Test
    @SneakyThrows
    public void createItem_whenItemDescriptionIsNull_thenReturnBadRequest() {
        //given
        ItemDto invalidItemDto = new ItemDto(
                1L,
                "New item",
    ...
    @Test
    @SneakyThrows
    public void createItem_whenItemAvailableIsNull_thenReturnBadRequest() {
        //given
        ItemDto invalidItemDto = new ItemDto(
                1L,
                "New item",
    ...
    @Test
    @SneakyThrows
    public void createComment_whenTextIsNull_thenReturnBadRequest() {
        //given
        CommentDto commentDto = new CommentDto(
                null,
                null,
    ...
    @Test
    @SneakyThrows
    public void createComment_whenTextIsBlank_thenReturnBadRequest() {
        //given
        CommentDto commentDto = new CommentDto(
                null,
                "  ",
    ...
    @Test
    @SneakyThrows
    void getItemsByUserId_whenParamFromLessZero_thenReturnBadRequest() {
        //when
        when(itemService.getItemsByOwnerId(eq(userId), any())).thenReturn(List.of(itemDto));

        mockMvc.perform(get("/items?from=-10")
                        .header("X-Sharer-User-Id", userId)
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
    ...
    void getItemsByKeyword_whenParameterIsNotProvided_thenUseDefaultValues() {
        ...
        //when
        when(itemService.getItemsByKeyword(any(), any())).thenReturn(List.of(itemDto));
        ...
        //then
        verify(itemService).getItemsByKeyword(textCaptor.capture(), pageableCaptor.capture());
    ...
    @Test
    @SneakyThrows
    void getItemsByKeyword_whenParamFromLessZero_thenReturnBadRequest() {
        //when
        when(itemService.getItemsByKeyword(any(), any())).thenReturn(List.of(itemDto));

        mockMvc.perform(get("/items/search?from=-10")
                        .header("X-Sharer-User-Id", userId)
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
        ...
        //then
        verify(itemService, never()).getItemsByKeyword(any(), any());
    }
